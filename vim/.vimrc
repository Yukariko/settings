...
"Plug 'vim-scripts/scrooloose/nerdtree'
Plug 'vim-scripts/EasyMotion'
"Plug 'vim-scripts/tpope/vim-endwise'
Plug 'vim-scripts/vim-coffee-script', { 'for': 'coffee' }
"Plug 'vim-scripts/scrooloose/syntastic'
Plug 'vim-scripts/hgrev'
"Plug 'vim-scripts/tpope/vim-rails'
Plug 'vim-scripts/tComment'
Plug 'vim-scripts/xmledit'
"Plug 'vim-scripts/tpope/vim-fugitive'
"Plug 'vim-scripts/bling/vim-airline'
"Plug 'vim-scripts/khwon/Vim-Tomorrow-Theme'
"Plug 'vim-scripts/xolox/vim-misc'
"Plug 'xolox/vim-easytags'
Plug 'vim-scripts/indenthtml.vim'
Plug 'vim-scripts/vim-javascript'
Plug 'vim-scripts/vim-eco'
"Plug 'vim-scripts/khwon/cscope_maps.vim'
"Plug 'vim-scripts/vim-ruby/vim-ruby'
"Plug 'vim-scripts/airblade/vim-gitgutter'
"Plug 'vim-scripts/tpope/vim-dispatch'
"Plug 'vim-scripts/jiangmiao/auto-pairs'
"Plug 'vim-scripts/khwon/vim-conflicted'
" Provide CamelCase motion through words
"Plug 'vim-scripts/bkad/CamelCaseMotion'
